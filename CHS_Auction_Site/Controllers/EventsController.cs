...
namespace CHS_Auction_Site.Controllers
{
    public class EventsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EventId,EventLocation,EventTicketNum,EventStart,EventEnd")] Events events)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,EventLocation,EventTicketNum,EventStart,EventEnd")] Events events)
        {
